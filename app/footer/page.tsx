...
const Footer = () => {
  return (
    <footer className="bg-black text-white border-t border-t-[#33353F] py-6 md:py-8">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-6 space-y-6 md:space-y-0 text-center md:text-left">
        
      
        <div className="flex items-center justify-center md:justify-start">
          <h4 className="text-2xl sm:text-3xl font-extrabold bg-gradient-to-tr from-fuchsia-600 to-pink-600 bg-clip-text text-transparent">
            Maryam Faizan
          </h4>
        </div>
        
        
        <ul className="flex flex-wrap gap-4 justify-center md:justify-start text-sm sm:text-md font-bold">
          <li>
            <Link href="/about">
              <span className="hover:text-pink-600 transition decoration-transparent text-white">About</span>
            </Link>
          </li>
          <li>
            <Link href="/skills">
              <span className="hover:text-pink-600 transition decoration-transparent text-white">Skills</span>
            </Link>
          </li>
          <li>
            <Link href="/projects">
              <span className="hover:text-pink-600 transition decoration-transparent text-white">Projects</span>
            </Link>
          </li>
          <li>
            <Link href="/contact">
              <span className="hover:text-pink-600 transition decoration-transparent text-white">Contact</span>
            </Link>
          </li>
        </ul>
