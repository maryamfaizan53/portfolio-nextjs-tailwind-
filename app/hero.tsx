...
//       <main className="relative z-20 flex flex-col lg:flex-row items-center lg:items-start text-center lg:text-left w-full h-screen lg:w-1/4 xl:w-1/2 mx-auto px-4 sm:px-6 md:px-8">
        
//         {/* Profile Image */}
//         <div className="relative z-20 w-32 h-32 sm:w-40 sm:h-40 lg:w-48 lg:h-48 mt-8 lg:mt-0 lg:mr-8">
//           <Image
//             src="/hero-image.png"
//             alt="profile pic"
//             width={840}
...
//         {/* Text Section */}
//         <div className="relative z-20 w-full mt-4 lg:mt-0 lg:ml-8 flex flex-col items-center lg:items-start text-white">
//           <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-tight text-shadow-lg mb-2">
//             <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-purple-600">
//               Hello, I&apos;m
//             </span>
//           </h1>
...
//           {/* Type Animation */}
//           <div className="text-2xl sm:text-3xl lg:text-4xl font-extrabold leading-tight mt-2 text-shadow-lg">
//             <TypeAnimation
//               sequence={[
//                 'Maryam Faizan',
//                 1000,
...
//           {/* Description */}
//           <p className="mt-4 text-sm sm:text-base lg:text-lg font-light max-w-md lg:max-w-lg px-4 lg:px-0">
//             I am a full-stack web developer with a passion for creating interactive
//             and responsive web applications. I have experience working with JavaScript,
//             TypeScript, React, Next.js, Node.js, Express, Bootstrap, HTML, CSS, and Git.
//             I am a quick learner and always looking to expand my knowledge and skill set.
...
//           {/* Social Icons */}
//           <div className="w-full flex justify-center sm:justify-start mt-5 space-x-6 text-2xl sm:text-3xl lg:text-4xl flex-wrap">
//             <FaGithub
//               className="text-white cursor-pointer shadow-md p-2 rounded-full bg-pink-600 hover:bg-fuchsia-600 transition-all duration-300 ease-in-out"
//               style={{ boxShadow: '0 0 20px rgba(255, 69, 0, 0.6)' }}
//               onClick={() => openLink('https://github.com')}
//               aria-label="GitHub"
//             />
//             <FaLinkedin
  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <main className="relative z-20 flex flex-col lg:flex-row items-center lg:items-start text-center lg:text-left w-full h-screen lg:w-3/4 xl:w-1/2 mx-auto px-4 sm:px-6 md:px-8">
        ...
        {/* Profile Image */}
        <div className="relative z-20 w-56 h-56 sm:w-72 sm:h-72 lg:w-96 lg:h-96 mt-8 lg:mt-0 lg:mr-8">
          <Image
            src="/hero-image.png"
            alt="profile pic"
            width={960}
        ...
        <div className="relative z-20 w-full mt-4 lg:mt-0 lg:ml-8 flex flex-col items-center lg:items-start text-white">
          {/* Static Text */}
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold leading-tight text-shadow-lg mb-2">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-purple-600">
              Hello, I&apos;m
            </span>
          </h1>
          ...
          {/* Description */}
          <p className="mt-4 text-lg sm:text-xl lg:text-2xl font-light max-w-lg px-4 lg:px-0">
            I am a full-stack web developer with a passion for creating interactive
            and responsive web applications. I have experience working with JavaScript,
            TypeScript, React, Next.js, Node.js, Express, Bootstrap, HTML, CSS, and Git.
            I am a quick learner and always looking to expand my knowledge and skill set.
          ...
          {/* Social Icons */}
          <div className="w-full flex justify-center sm:justify-start mt-5 space-x-8 sm:space-x-6 text-5xl sm:text-6xl flex-wrap">
            <FaGithub
              className="text-white cursor-pointer shadow-md p-3 rounded-full bg-pink-600 hover:bg-fuchsia-600 transition-all duration-300 ease-in-out"
              style={{ boxShadow: '0 0 30px rgba(255, 69, 0, 0.6)' }}
              onClick={() => openLink('https://github.com')}
              aria-label="GitHub"
            />
